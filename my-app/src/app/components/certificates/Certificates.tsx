...
import basics from "../../../../public/basics.jpeg";
...
export default function Certificates() {
    return (
        <section id="certificates">
                    ...
                    <Image className="w-40 rounded-md mx-auto mt-10" src={softuni} alt="SoftUni"/>
                    ...
                    <Image className="w-40 rounded-md mx-auto mt-10" src={tuvarna} alt="SoftUni"/>
                    <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
                    ...
                    <Image className="w-40 rounded-md mx-auto mt-10" src={supne} alt="SoftUni"/>
                    <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
                        <div className="basis-1/10 flex-1">
                            <Image
                                className="rounded-lg object-cover w-full h-full"
